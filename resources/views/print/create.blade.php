...
<body>
  <div class="container mt-5">
    <h2 class="mb-4">Printing</h2>

    <!-- Form for submitting the data -->
    <form id="buyingForm" method="POST" action="{{ route('print.store') }}">
  ...
  <script>
    ...
    let newRow = `<tr id="row${rowCount}">
                    <td>${rowCount}</td>
                    <td><input type="text" class="form-control material" name="printing_type[]" placeholder="Enter Type"></td>

...
<body>
  <div class="container mt-5">
    ...
    <form id="buyingForm" method="POST" action="{{ route('cutting.store') }}">
  ...
  <script>
    ...
    let newRow = `<tr id="row${rowCount}">
                    <td>${rowCount}</td>
                    <td><input type="text" class="form-control material" name="cutting_type[]" placeholder="Enter Material"></td>

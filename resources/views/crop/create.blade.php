...
<head>
  ...
  <title>Cropping Table with Add Row Functionality</title>
...
<body>
  <div class="container mt-5">
    <h2 class="mb-4">Cropping</h2>

    <!-- Form for submitting the data -->
    <form id="buyingForm" method="POST" action="{{ route('crop.store') }}">
  ...
  <script>
    ...
    let newRow = `<tr id="row${rowCount}">
                    <td>${rowCount}</td>
                    <td><input type="text" class="form-control material" name="cropping_type[]" placeholder="Enter Type"></td>
